             ...
             style={{backgroundColor: '#282c34', 
                    ...
                    <span>
                      <img  className='float-end  mx-auto d-none d-md-block' src={crowd} alt='crowd'
                          style={{maxWidth: '15%'}}
                      />
                       <h3 style={{marginTop: '30px', marginLeft: '30px', marginRight: '15px'}}>The research of my thesis focuses on deploying a Crowd Simulator which contains all the 
                      ...
                      />
                        <img  className='float-start rounded-circle mx-auto d-none d-md-block' src={pytorch} alt='pytorch'
                          style={{maxWidth: '2%', marginTop: '35px', marginRight: '15px'}}
                      /> 
                      <span>
                        <h3 style={{marginTop: '30px', marginLeft: '30px', marginRight: '15px'}}>To create this Crowd Simulator, we use the graphic motor Unity to create a 
